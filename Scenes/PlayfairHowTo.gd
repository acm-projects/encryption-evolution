...
var dialogue = ["In order to use the playfair cipher, we need a keyword. For this tutorial we will use \"keyword\" as our keyword.",
...
"AG becomes DH",
"EX becomes WU",
"Encrypting is now finished! Decrypting a message will follow a similar process in reverse. Press continue to move on."]
